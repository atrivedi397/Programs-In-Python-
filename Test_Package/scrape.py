...
# need this import to save images in JSON file
import base64
import json

# need for opening files to write
import os

# These two last imports do not belong to the standard library.
# for scrapping the web page easily
